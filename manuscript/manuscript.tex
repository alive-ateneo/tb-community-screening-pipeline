...
Generative AI tools were used to assist in writing the manuscript and source code for the study. All outputs were reverified by the authors. The conception of the research, methodology, and conclusions are the work of the authors.
...
\begin{figure}[H]
    ...
    \caption{Pixel-intensity distributions of the datasets. Montgomery is darker and Shenzhen is brighter than the TBX11K training set.}
