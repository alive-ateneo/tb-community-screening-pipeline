...
Localization uses the same training configuration as the classification models (Section~\ref{sec:tb_classification}). As in classification, the best checkpoint (selected by mAP) is retained and used for evaluation.
